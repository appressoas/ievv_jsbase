...
var _LoggerSingleton = require("../LoggerSingleton");
...
describe('LoggerSingleton', function () {
    beforeEach(function () {
        new _LoggerSingleton2.default().reset();
    });

    it('LoggerSingleton() constructor', function () {
        var loggerSingleton = new _LoggerSingleton2.default();
        expect(loggerSingleton._logLevel).toBe(_loglevel2.default.WARNING);
        expect(loggerSingleton._loggerMap.size).toBe(0);
    });

    it('LoggerSingleton().getDefaultLogLevel() default', function () {
        var loggerSingleton = new _LoggerSingleton2.default();
        expect(loggerSingleton.getDefaultLogLevel()).toBe(_loglevel2.default.WARNING);
    });

    it('LoggerSingleton().setDefaultLogLevel() updates _logLevel', function () {
        var loggerSingleton = new _LoggerSingleton2.default();
        loggerSingleton.setDefaultLogLevel(_loglevel2.default.DEBUG);
        expect(loggerSingleton._logLevel).toBe(_loglevel2.default.DEBUG);
    });
    ...
    it('LoggerSingleton().setDefaultLogLevel() updates changes getDefaultLogLevel() output', function () {
        var loggerSingleton = new _LoggerSingleton2.default();
        loggerSingleton.setDefaultLogLevel(_loglevel2.default.DEBUG);
        expect(loggerSingleton.getDefaultLogLevel()).toBe(_loglevel2.default.DEBUG);
    });

    it('LoggerSingleton().getLogger() return type', function () {
        var loggerSingleton = new _LoggerSingleton2.default();
        expect(loggerSingleton.getLogger('test')).toBeInstanceOf(_Logger2.default);
    });
    ...
    it('LoggerSingleton().getLogger() updates _loggerMap on first call', function () {
        ...
        expect(loggerSingleton._loggerMap.get('test')).toBeInstanceOf(_Logger2.default);
    ...
    it('LoggerSingleton().getDebugInfoString() change default logLevel', function () {
        var loggerSingleton = new _LoggerSingleton2.default();
        loggerSingleton.setDefaultLogLevel(_loglevel2.default.INFO);
    ...
    it('LoggerSingleton().getDebugInfoString() with loggers', function () {
        var loggerSingleton = new _LoggerSingleton2.default();
        loggerSingleton.getLogger('test3');
        loggerSingleton.getLogger('test1').setLogLevel(_loglevel2.default.WARNING);
        loggerSingleton.getLogger('test2').setLogLevel(_loglevel2.default.SILENT);
        loggerSingleton.setDefaultLogLevel(_loglevel2.default.DEBUG);
