...
function (_AbstractBackend) {
  ...
  function DjangoBackend() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(DjangoBackend).apply(this, arguments));
  }

  _createClass(DjangoBackend, [{
    key: "gettext",
...
exports.DjangoBackend = DjangoBackend;