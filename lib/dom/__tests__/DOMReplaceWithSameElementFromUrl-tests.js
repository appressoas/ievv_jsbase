...
var MockDOMReplaceWithSameElementFromUrl =
/*#__PURE__*/
function (_DOMReplaceWithSameEl) {
  function MockDOMReplaceWithSameElementFromUrl() {
    _classCallCheck(this, MockDOMReplaceWithSameElementFromUrl);

    return _possibleConstructorReturn(this, _getPrototypeOf(MockDOMReplaceWithSameElementFromUrl).apply(this, arguments));
  }
