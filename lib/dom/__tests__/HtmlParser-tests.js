...
describe('HtmlParser', function () {
    it('HtmlParser().rootElements', function () {
        var elements = new _HtmlParser2.default('<p>Test</p><span>Test2</span>').rootElements;
    ...
    it('HtmlParser().firstRootElement', function () {
        var element = new _HtmlParser2.default('<p>Test</p>').firstRootElement;
        expect(element.textContent).toBe('Test');
        expect(element.tagName.toLowerCase()).toBe('p');
    });

    it('HtmlParser().querySelector()', function () {
        var element = new _HtmlParser2.default('<p>Test</p>').querySelector('p');
        expect(element.textContent).toBe('Test');
        expect(element.tagName.toLowerCase()).toBe('p');
    });

    it('HtmlParser() querySelectorAll', function () {
        var elements = new _HtmlParser2.default('<p>Test1</p><p>Test2</p>').querySelectorAll('p');
        expect(elements.length).toBe(2);
    ...
    it('HtmlParser() tree', function () {
        var htmlParser = new _HtmlParser2.default('<p><em>Test1</em><strong>Test2</strong></p>');
    ...
    it('HtmlParser() HTML document', function () {
        var htmlParser = new _HtmlParser2.default('<html><body><p>Test</p></body></html>');
