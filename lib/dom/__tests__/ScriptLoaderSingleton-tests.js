...
var _ScriptLoaderSingleton = require('../ScriptLoaderSingleton');

var _ScriptLoaderSingleton2 = _interopRequireDefault(_ScriptLoaderSingleton);
...
describe('ScriptLoaderSingleton', function () {
  it('ScriptLoaderSingleton.load() adds script tag', function () {
    ...
    var scriptLoader = new _ScriptLoaderSingleton2.default();
