...
var _CleanHtml = require("../CleanHtml");

var _CleanHtml2 = _interopRequireDefault(_CleanHtml);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

describe('CleanHtml', function () {
    it('sanity', function () {
        var htmlCleaner = new _CleanHtml2.default();
    ...
    it('splits node at paste-marker', function () {
        ...
        rootNode.addChildNode(outerPTag);
        var pasteMarkerNode = new _CleanHtml.CleanerNode(options, outerPTag, rootNode, true, 'span', { 'data-ievv-paste-marker': '' });
