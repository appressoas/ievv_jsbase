 ...
 */
var HttpDjangoFileRequest = exports.default = /*#__PURE__*/function (_HttpFileRequest) {
  /**
  ...
  function HttpDjangoFileRequest() {
    ...
    _this = _callSuper(this, HttpDjangoFileRequest, [].concat(args));
  ...
  return _createClass(HttpDjangoFileRequest, [{
    key: "csrftoken",
    get: function get() {
