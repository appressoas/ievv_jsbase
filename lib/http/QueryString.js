...
var QueryString = function () {
  ...
  _createClass(QueryString, [{
    ...
    value: function merge() {
      for (var _len = arguments.length, queryStringObjects = Array(_len), _key = 0; _key < _len; _key++) {
      ...
      try {
        for (var _iterator4 = queryStringObjects[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
          var queryStringObject = _step4.value;
          var _iteratorNormalCompletion5 = true;
          var _didIteratorError5 = false;
          var _iteratorError5 = undefined;

          try {
            for (var _iterator5 = queryStringObject._queryStringMap[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
    ...
    value: function setSmart(key, value) {
      var valueType = (0, _typeDetect2.default)(value);
    ...
    value: function urlencode() {
      ...
      try {
        for (var _iterator7 = keys[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
          ...
          try {
            for (var _iterator8 = valueArray[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
