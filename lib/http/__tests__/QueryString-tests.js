...
describe('QueryString', function () {
  ...
  it('isEmpty()', function () {
    var querystring = new _QueryString2.default();
  ...
  it('urlencode sortValues', function () {
    ...
    expect(querystring.urlencode({ sortValues: true })).toEqual('name=Amy&name=Jane&name=Xian');
  });
  ...
  it('urlencode sortKeys and sortValues', function () {
    ...
    expect(querystring.urlencode({ sortKeys: true, sortValues: true })).toEqual('age=2&age=33&age=66&name=Amy&name=Jane&name=Xian');
  });

  it('parse', function () {
    var querystring = new _QueryString2.default('name=Jane');
