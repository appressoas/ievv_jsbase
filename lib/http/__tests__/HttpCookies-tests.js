...
var _HttpCookies = require('../HttpCookies.js');
...
describe('HttpCookies', function () {
    it('HttpCookies.contains()', function () {
        var cookies = new _HttpCookies2.default('other=othervalue;test=testvalue;evenanother=evenanothervalue');
    ...
    it('HttpCookies.get() simple', function () {
        var cookies = new _HttpCookies2.default('test=testvalue');
    ...
    it('HttpCookies.get() from document', function () {
        ...
        var cookies = new _HttpCookies2.default();
