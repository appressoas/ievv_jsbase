...
function (_HttpRequest) {
  function JsonHttpRequest() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(JsonHttpRequest).apply(this, arguments));
  }
  ...
  _createClass(JsonHttpRequest, [{
    ...
    value: function setDefaultRequestHeaders(method) {
      _get(_getPrototypeOf(JsonHttpRequest.prototype), "setDefaultRequestHeaders", this).call(this, method);
